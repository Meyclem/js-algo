 ...
 * - utiliser 'Array.Prototype.filter()', lien vers la doc dans le README.MD 😉
 */
 ...
 * @param {string} letter 
 */
const filterNames = (firstNames, letter) => firstNames
    .filter((name) => name[0].toLowerCase() === letter.toLowerCase());
